...
var SESMailer = function (_BaseMailer) {
  ...
  function SESMailer(config) {
    _classCallCheck(this, SESMailer);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SESMailer).call(this, config));

    _this.setProvider(_nodemailer2.default.createTransport((0, _nodemailerSesTransport2.default)(_this.get('provider'))));
    return _this;
  }
