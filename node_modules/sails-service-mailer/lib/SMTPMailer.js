...
var SMTPMailer = function (_BaseMailer) {
  ...
  function SMTPMailer(config) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SMTPMailer).call(this, config));

    _this.setProvider(_nodemailer2.default.createTransport((0, _nodemailerSmtpTransport2.default)(_this.get('provider'))));
    return _this;
  }
