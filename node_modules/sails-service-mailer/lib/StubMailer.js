...
var StubMailer = function (_BaseMailer) {
  ...
  function StubMailer(config) {
    _classCallCheck(this, StubMailer);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StubMailer).call(this, config));

    _this.setProvider(_nodemailer2.default.createTransport((0, _nodemailerStubTransport2.default)(_this.get('provider'))));
    return _this;
  }
