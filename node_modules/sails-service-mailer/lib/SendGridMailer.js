...
var SendGridMailer = function (_BaseMailer) {
  ...
  function SendGridMailer(config) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SendGridMailer).call(this, config));

    _this.setProvider(_nodemailer2.default.createTransport((0, _nodemailerSendgridTransport2.default)(_this.get('provider'))));
    return _this;
  }
